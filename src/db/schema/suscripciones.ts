...
export const suscripciones = sqliteTable('suscripciones', {
    ...
    fechaCancelacion: integer('fechaCancelacion', { mode: 'timestamp' }),// Para cuando el usuario  cancela la suscripcion
    planSnapshot: text('planSnapshot', { mode: 'json' }), // Snapshot de los limites al momento de contratar
