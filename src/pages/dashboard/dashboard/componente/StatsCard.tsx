...
export default function StatsCard({ id, title, value, icon: Icon, color, trend, subtitle }: Props) {
  return (
    <div className="flex flex-col flex-1 min-w-[200px] p-4 bg-gradient-to-tr from-primary-100/20 to-primary-400/20 hover:-translate-y-1 overflow-hi hover:-translate-x-0.5 rounded-lg border duration-300 border-gray-200 shadow-sm justify-between gap-2 relative group">
