...
export default function WhatsAppSetup({ centroMedicoId }: WhatsAppSetupProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {status === 'disconnected' && (
        <div className="space-y-4">
          <p className="text-gray-600">
            Conecta tu WhatsApp para recibir mensajes de pacientes directamente en tu telefono.
          </p>
          <Button
      ...
      {status === 'qr_pending' && (
        <div className="space-y-4">
          <p className="text-gray-600">Escanea este codigo QR con WhatsApp en tu telefono</p>
      ...
      {status === 'connected' && (
        <div className="space-y-4">
          ...
          <Button onClick={handleDisconnect} disabled={loading} variant="cancel" className="w-full">
