...
interface FormularioRapicoCargaPacienteProps {
...
export const FormularioRapicoCargaPaciente: React.FC<FormularioRapicoCargaPacienteProps> = ({
  onPacienteCreado,
  isStoreAgenda = true,
  userId,
  onCancel,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const nuevoPaciente = result.data.paciente;
